...
print('la risoluzione è=%.3f'% (resolution))
##plot 
...
counts,energy=pylab.loadtxt('provadata.txt',unpack=True) 
Ds=1.75 #errore a caso, usa la fwhm dal fit gaussiano
def f1(x,m,q):
...
def prediction(x):
    return x/m-q-11
print(prediction(22),prediction(60))
